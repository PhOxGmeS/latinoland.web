        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 py-4">
          ...
          <div className="self-end sm:self-center">
            <Tabs value={activeTab} onValueChange={setActiveTab}>
                <TabsList>
                    <TabsTrigger value="inicio" className="uppercase text-xs tracking-wider px-4">Inicio</TabsTrigger>
                    ...
                    <TabsTrigger value="paquetes" className="uppercase text-xs tracking-wider px-4">Paquetes</TabsTrigger>
                    <TabsTrigger value="redes" className="uppercase text-xs tracking-wider px-4">Redes</TabsTrigger>
                </TabsList>
            </Tabs>
          </div>
        </div>
